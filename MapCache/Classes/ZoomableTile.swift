...
public struct ZoomableTile {
    ...
    public var maximumZPath: MKTileOverlayPath
    ...
    public var overZoom: Int

    public init(maximumZPath: MKTileOverlayPath, rect: MKMapRect, overZoom: Int) {
        self.maximumZPath = maximumZPath
        self.rect = rect
